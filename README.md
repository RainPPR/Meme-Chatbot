# AI Chat Assistant (作梗/Meme Chatbot)

一个外观极为正经、功能完整的极简现代 AI 对话 Web 应用，内置经典 AI 作梗响应引擎。
...
- **作梗响应引擎**：
  ...
  - 拟真展示「思考中...」动画（随机 0.5s ～ 1.5s 延迟），随后直接输出。
...
- **静态导出与 GitHub Pages 兼容**：
  ...
  - 内置 GitHub Actions 工作流文件，直接 `git push` 到 GitHub 仓库即可自动构建并发布到 GitHub Pages。
...
3. GitHub Actions 将自动执行静态编译并部署到 GitHub Pages。
